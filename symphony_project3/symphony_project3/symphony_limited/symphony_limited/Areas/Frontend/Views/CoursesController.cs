...
namespace symphony_limited.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,NameCourse,Price,Status,Description,Numberofsession,TeacherId,Img,CategoryId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,NameCourse,Price,Status,Description,Numberofsession,TeacherId,Img,CategoryId")] Course course)
        {
            if (ModelState.IsValid)
            {
